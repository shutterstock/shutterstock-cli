...
class RequestHelperTests(unittest.TestCase):
    ...
    def test_request_helper_with_token(self):
        ...
        req = RequestHelper()
        self.assertEqual(req.headers, {"Authorization": "Bearer 1", "User-Agent": "Shutterstock-CLI"})
    ...
    def test_request_helper_with_auth(self):
        ...
        self.assertEqual(req.headers, {"User-Agent": "Shutterstock-CLI"})
...
class RequestTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.headers = {"User-Agent": "Shutterstock-CLI", "Authorization": "Bearer a"}
