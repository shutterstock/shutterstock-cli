...
@click.option(
    ...
    multiple=False,
    help=(
        "Set to true and specify the `ai_objective` and `ai_industry` parameters to use"
        " AI-powered search; the API returns information about how well images meet the"
...
@click.option(
    "--ai-labels-limit",
    multiple=False,
    help="For AI-powered search, specify the maximum number of labels to return",
    type=int,
)
@click.option(
    "--ai-industry",
    multiple=False,
    help=(
        "For AI-powered search, specify the industry to target; requires that the"
        " `ai_search` parameter is set to true"
    ),
    type=str,
)
@click.option(
    ...
    multiple=False,
    help=(
        "For AI-powered search, specify the goal of the media; requires that the"
        " `ai_search` parameter is set to true"
    ),
    type=str,
)
