...
@click.option(
    ...
    help=(
        ...
        " `standard` or `enhanced`; prepending a `-` sign excludes results from that"
        " license"
    ),
    type=str,
)
...
sfx.add_command(licenses_s_f_x)
