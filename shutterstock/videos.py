...
@click.option(
    "--orientation",
    multiple=False,
    help="Search for videos in a specific orientation",
    type=str,
)
...
@click.option(
    ...
    multiple=False,
    help=(
        "Show videos updated on or after the specified date. The API will default to"
...
@click.option(
    ...
    multiple=False,
    help=(
        "Show videos updated before the specified date. The API will default to UTC"
